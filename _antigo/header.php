		...
		<header id="header" class="full-header">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="/" class="standard-logo" data-dark-logo="_galerias/logo.png"><img src="_galerias/logo.png" alt="<?=$sitename;?>"></a>
						<a href="/" class="retina-logo" data-dark-logo="_galerias/logo.png"><img src="_galerias/logo.png" alt="<?=$sitename;?>"></a>					
					</div><!-- #logo end -->
